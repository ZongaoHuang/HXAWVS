...
urlpatterns = [
    ...
    path('finger_print_result/<int:scan_id>/', views.finger_print_result, name='finger_print_result'),
    path('get_finger_print', views.get_finger_print, name='get_finger_print'),
    path('delete_finger_print', views.delete_finger_print, name='delete_finger_print'),
    # 子域名探测
